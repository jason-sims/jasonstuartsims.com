      ...
      >
        <div>
          ...
          <p className="font-medium text-base text-justify leading-relaxed py-2">
            I wanted to create a personal portfolio site to showcase my work and
            also develop my Next.js & Tailwind skills.
          </p>
          <h2 className="uppercase pb-4">Approach</h2>
          <p className="font-medium text-base text-justify leading-relaxed py-2">
            I developed an initial release and my intention is to iterate on the
            site seeking direct feedback on both the content and code base.
          </p>
          <h2 className="uppercase pb-4">Outcome</h2>
          <p className="font-medium text-base text-justify leading-relaxed py-2">
