...
I joined the programme team early in the bid phase and was tasked with outlining/scoring digital requirements for potential transport suppliers.
            ...
            <h2 className="uppercase py-4">Approach    
            </h2>
            <p className="font-medium text-base text-justify leading-relaxed py-2">
            ...
            <table class="table-fixed text-left py-2">
  <thead>
    <tr>
      <th class="py-4">Component</th>
      <th class="py-4">Book a secure move benefits</th>
  ...
  <tbody >
    <tr>
      <td>Move requests</td>
      <td class="py-2">Provide an overview of the current and projected prison population and enable single and bulk transfer requests between prisons supported by prisoner profile search</td>
      
    </tr>
    <tr>
      <td>Complex risk & medical assessments</td>
      <td class="py-2">Each move required detailed assessments, these could be partially pre-filled from previous forms and other systems saving significant time over completing paper forms</td>
      
    </tr>
    <tr>
      <td>Handover</td>
      <td class="py-2">Final checks and confirmation for transfer of care</td>  
    </tr>

    <tr>
      <td>Events</td>
      <td class="py-2">Suppliers provide notifications of events that occur whilst a move is underways</td>
      
    </tr>
    <tr>
      <td>Location</td>
      <td class="py-2">Suppliers provide GPS locations for vehicles, this both improves safety but also helps sending/receiving locations better plan resources</td>
      
    </tr>
    <tr>
      <td>Billing & compliance data</td>
      <td class="py-2">Provide a single source of truth for move requests against authenticated HMPPS users. This would greatly reduce assurance workload (approx 5,000 manually checked records month) and deliver automated costing of moves</td>
...
The programme and digital team worked closely together to identify key stakeholders and ensure appropriate governance was in place.  
          ...
          <p className="font-medium text-base text-justify leading-relaxed py-2">Squads formed to focus on specific areas of the service alongside business change to ensure a shared understanding and develop relationships with stakeholders. We started with a limited number of sites initially who were willing to participate in research and test Alpha & Beta versions of the service.</p>

            <div className=" h-auto m-auto">
            <Image src={Roadmap} alt="/" />
          </div>

          <h2 className="uppercase py-4">Rollout
            </h2>
            <p className="font-medium text-base text-justify leading-relaxed py-2">
            ...
            <p className="font-medium text-base text-justify leading-relaxed py-2">
            <ul class="list-disc">
  <li>over 25k users across 772 sites  (prisons/police custody/youth estate/courts)</li>
  <li>multiple cross government stakeholders at site, regional & national level </li>
...
<div className=" h-auto m-auto">
          ...
          <h2 className="uppercase py-4">Data
            </h2>
            <p className="font-medium text-base text-justify leading-relaxed py-2">
...
<p className="font-medium text-base text-justify leading-relaxed py-2">
<ul class="list-disc">
  <li>percentage of moves requested on the service vs requested via email/phone for each site</li>
  <li>number of risk assessments started online vs completed online vs completed on paper for each site </li>
...
A large number of reports were developed over time to support compliance reporting providing valuable insights that previously were not available or required substantial manual effort to produce. 
            ...
            <h2 className="uppercase py-4">Outcome
            </h2>
            <p className="font-medium text-base text-justify leading-relaxed py-2">
...
<blockquote className="p-4 italic bg-neutral-100 text-neutral-600 quote ">
  <p className="mb-2">"Thank you for the excellent work, perseverance and superhuman effort seen across the teams to deliver the significant solutions and services which have been provided on behalf of the PECS Generation 4 Programme. The systems, engagement, supporting services and continued improvements that have been delivered to colleagues across the justice estate have proven to be not only well received, but also facilitating significant positive change in this environment."</p>
  <cite>
...
<h2 className="uppercase py-4">Further reading
            </h2>
            <p className="font-medium text-base text-justify leading-relaxed py-2">
