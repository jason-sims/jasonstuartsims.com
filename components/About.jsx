    ...
    <div id="about" className="max-w-[1240px] h-auto pt-20 p-4 m-auto">
        <div className="grid lg:grid-cols-2 gap-5">
          ...
          <h1 className="uppercase pb-4">About Jason</h1>
            ...
            <p className="font-medium text-base text-justify leading-relaxed pt-2">
              I grew up in a military family completing high school in
              Australia in 2001. Originally passing on university, my first working decade was filled with
            roles in childcare, manufacturing, IT support,
              training and payroll. In 2013 I completed a Bachelor of Business
              (Management & Leadership) and secured my first product owner role.
            ...
            <p className="font-medium text-base text-justify leading-relaxed pt-2">
              ...
              insurance and consulting. I am forever curious, I want to
              understand the entire customer journey and make timely, evidence
              based decisions.
            </p>
            <p className="font-medium text-base text-justify leading-relaxed pt-2">
              In my spare time you will find me developing, renovating, spending time with
              my family and dreaming about a sailing holiday.
            </p>
          </div>
        </div>
    </div>
